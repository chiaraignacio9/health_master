<form class="w-full space-y-5" autocomplete="off" wire:submit.prevent="storePatient">
    ...
    <div class="w-full flex gap-2">
        <div class="w-1/2">
            ...
            <select class="w-full text-center " name="id_prepaga" id="id_prepaga">
    ...
    <div class="text-center">
        <input class="py-2 px-3 bg-green-400 rounded font-semibold" type="submit" value="Crear Paciente">
    </div>
</form>
